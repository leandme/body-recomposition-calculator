...
export const metadata: Metadata = {
  title: "Subprocessors - Body Recomposition Calculator",
  description: "Third-party service providers that may process data for Body Recomposition Calculator.",
};
  ...
  return (
    <div className="container mx-auto px-4 py-8 lg:px-8 lg:py-16 max-w-4xl">
      ...
      <p className="text-lg mb-6">
        Body Recomposition Calculator may rely on third-party infrastructure and service providers to
